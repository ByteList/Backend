 ...
 */
public class WebsiteTable implements SqlLiteTable {
    ...
    public WebsiteTable(SupportDatabase database) {
        this.database = database;

        this.supportTab = SupportTab.WEBSITE;
    ...
    public String insert(int ticketId, String topic, String url, String subject, String msg) {
